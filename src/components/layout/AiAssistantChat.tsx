...
export default function AiAssistantChat({ initialPrompt, onPromptChange, onBack, dragControls, handleToggleFullScreen, isFullScreen, textareaRef }: AiAssistantChatProps) {
    ...
    <div className="flex flex-col h-full bg-[#1d2025] text-white rounded-xl overflow-hidden">
        ...
        <div className="flex flex-1 min-h-0">
            ...
            <div className="flex-1 flex flex-col">
                ...
                {/* Input Area */}
                <div 
                    className="relative w-full flex items-center text-gray-400 py-2 px-3"
