                    ...
                    <div className="p-4">
                        <TabsContent value="terms">
                            <LegalModalContent title="Terms and Conditions">
                                ...
                                <p><strong>1. Acceptance of Terms:</strong> By accessing and using Career Calender ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. In addition, when using these particular services, you shall be subject to any posted guidelines or rules applicable to such services.</p>
                                ...
                                <p><strong>4. Intellectual Property:</strong> The Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of Career Calender and its licensors. The Service is protected by copyright, trademark, and other laws of both the country and foreign countries.</p>
                                
                                <p><strong>5. Limitation of Liability:</strong> In no event shall Career Calender, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
                        ...
                        <TabsContent value="privacy">
                            <LegalModalContent title="Privacy Policy">
                                <p><strong>Last updated: {new Date().toLocaleDateString()}</strong></p>
                                <p>Career Calender ("us", "we", or "our") operates the Career Calender application (the "Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service.</p>
                                ...
                                <p><strong>2. Use of Data:</strong> Career Calender uses the collected data for various purposes: to provide and maintain the Service; to notify you about changes to our Service; to provide customer care and support; to provide analysis or valuable information so that we can improve the Service.</p>
                        ...
                        <TabsContent value="refund">
                             <LegalModalContent title="Cancellation & Refund Policy">
                                <p><strong>Last updated: {new Date().toLocaleDateString()}</strong></p>
                                <p>This policy outlines the terms for cancellation and refunds for subscriptions to the Career Calender service.</p>
                         ...
                         <TabsContent value="shipping">
                             <LegalModalContent title="Shipping & Delivery Policy">
                                ...
                                <p><strong>1. Nature of Service:</strong> Career Calender is a fully digital Software-as-a-Service (SaaS) application. We do not sell or ship any physical goods or products.</p>
