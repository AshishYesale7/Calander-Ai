...
const AppleIcon = () => <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="mr-2 h-4 w-4 fill-current"><title>Apple</title><path d="M17.478.015C15.82-.475 12.285.355 10.59 2.155c-1.68 1.785-2.655 4.335-2.22 6.885 1.98-1.2 4.395-1.92 6.96-1.635 1.335.15 2.895.735 4.29 1.935-1.785.96-3.375 2.37-4.5 4.155-1.14 1.785-1.575 3.84-1.2 5.925 1.56.285 3.255-.165 4.785-1.185 1.545-.99 2.655-2.67 3.375-4.515.15-.36.21-.735.21-1.125 0-1.875-2.4-4.395-2.4-4.41-3.15-2.58-6.195-2.535-6.21-2.535-.18 0-3.345.03-5.595 2.1-1.56 1.485-2.85 3.96-2.85 6.66 0 4.335 2.82 6.27 5.535 6.27 2.115 0 3.51-1.125 5.595-1.125 2.085 0 3.33 1.125 5.61 1.125 2.745 0 5.235-2.4 5.235-6.36 0-3.285-2.235-5.52-4.44-6.81.18-.3.33-.615.465-.945z"></path></svg>;
