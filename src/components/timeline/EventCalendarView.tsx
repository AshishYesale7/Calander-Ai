      ...
      <CardHeader>
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-1 bg-black/50 backdrop-blur-md p-1 rounded-full border border-border/30">
              <Button variant="ghost" size="icon" onClick={onSync} disabled={isSyncing} className="h-9 w-9 text-gray-300 hover:text-white hover:bg-white/10">
                  <RefreshCw className={cn("h-5 w-5", isSyncing && "animate-spin")} />
                  <span className="sr-only">Sync with Google Calendar</span>
              </Button>
              <Button variant="ghost" size="icon" onClick={onToggleTrash} className="h-9 w-9 text-gray-300 hover:text-white hover:bg-white/10">
