...
const studentLayoutLg: Layout[] = [
  { i: "plan", x: 0, y: 0, w: 12, h: 10, minW: 3, minH: 2 },
  { i: "streak", x: 7, y: 1, w: 5, h: 2, minW: 3, minH: 2 },
  { i: "calendar", x: 0, y: 1, w: 6, h: 5, minW: 3, minH: 2 },
  { i: "day-timetable", x: 0, y: 6, w: 6, h: 5, minW: 3, minH: 3 },
  { i: "timeline", x: 6, y: 11, w: 6, h: 4, minW: 3, minH: 2 },
  { i: "emails", x: 6, y: 6, w: 6, h: 5, minW: 3, minH: 2 },
  { i: "next-month", x: 8, y: 3, w: 4, h: 3, minW: 3, minH: 2 },
];

const studentLayoutMd: Layout[] = [
  { i: "plan", x: 0, y: 0, w: 10, h: 2, minW: 3, minH: 2 },
  { i: "streak", x: 6, y: 2, w: 4, h: 3, minW: 3, minH: 2 },
  { i: "calendar", x: 0, y: 2, w: 5, h: 5, minW: 3, minH: 2 },
...
const studentLayoutSm: Layout[] = [
  { i: "plan", x: 0, y: 0, w: 6, h: 1, minW: 3, minH: 2 },
  { i: "streak", x: 0, y: 1, w: 6, h: 3, minW: 3, minH: 2 },
  { i: "calendar", x: 0, y: 4, w: 6, h: 5, minW: 3, minH: 2 },
...
const professionalLayoutLg: Layout[] = [
  { i: "plan", x: 0, y: 0, w: 12, h: 1, minW: 2, minH: 2 },
  { i: "calendar", x: 0, y: 1, w: 6, h: 5, minW: 2, minH: 2 },
  { i: "day-timetable", x: 6, y: 1, w: 6, h: 6, minW: 2, minH: 3 },
  { i: "timeline", x: 6, y: 7, w: 6, h: 4, minW: 2, minH: 2 },
  { i: "emails", x: 0, y: 6, w: 6, h: 5, minW: 2, minH: 2 },
  { i: "next-month", x: 0, y: 11, w: 6, h: 4, minW: 2, minH: 2 },
];

const professionalLayoutMd: Layout[] = [
  { i: "plan", x: 0, y: 0, w: 10, h: 1, minW: 2, minH: 2 },
  { i: "calendar", x: 0, y: 1, w: 5, h: 4, minW: 2, minH: 2 },
...
const professionalLayoutSm: Layout[] = [
  { i: "plan", x: 0, y: 0, w: 6, h: 1, minW: 2, minH: 2 },
