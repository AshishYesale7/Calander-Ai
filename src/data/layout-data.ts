...
const studentLayoutLg: Layout[] = [
  ...
  { i: "streak", x: 6, y: 1, w: 6, h: 2, minW: 3, minH: 2 },
  ...
  { i: "next-month", x: 6, y: 3, w: 6, h: 3, minW: 3, minH: 3 },
...
const studentLayoutMd: Layout[] = [
  ...
  { i: "streak", x: 6, y: 1, w: 4, h: 3 },
  { i: "calendar", x: 0, y: 1, w: 6, h: 5 },
  { i: "day-timetable", x: 0, y: 6, w: 10, h: 4 },
  { i: "timeline", x: 0, y: 10, w: 10, h: 3 },
  { i: "emails", x: 0, y: 13, w: 10, h: 4 },
  { i: "next-month", x: 0, y: 17, w: 10, h: 2 },
