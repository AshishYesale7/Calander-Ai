...
const studentLayoutLg: Layout[] = [
  { i: "plan", x: 0, y: 0, w: 12, h: 1, minW: 3, minH: 2, autoSize: true },
...
const studentLayoutMd: Layout[] = [
  { i: "plan", x: 0, y: 0, w: 10, h: 1, minW: 3, minH: 2, autoSize: true },
...
const studentLayoutSm: Layout[] = [
  { i: "plan", x: 0, y: 0, w: 6, h: 1, minW: 3, minH: 2, autoSize: true },
...
const professionalLayoutLg: Layout[] = [
  { i: "plan", x: 0, y: 0, w: 12, h: 1, minW: 2, minH: 2, autoSize: true },
...
const professionalLayoutMd: Layout[] = [
  { i: "plan", x: 0, y: 0, w: 10, h: 1, minW: 2, minH: 2, autoSize: true },
...
const professionalLayoutSm: Layout[] = [
  { i: "plan", x: 0, y: 0, w: 6, h: 1, minW: 2, minH: 2, autoSize: true },
