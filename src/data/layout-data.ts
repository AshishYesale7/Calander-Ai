...
const studentLayoutMd: Layout[] = [
  ...
  { i: "sync", x: 0, y: 19, w: 5, h: 2 },
  { i: "data", x: 5, y: 19, w: 5, h: 2 },
];
...
const studentLayoutSm: Layout[] = [
  ...
  { i: "sync", x: 0, y: 23, w: 3, h: 2 },
  { i: "data", x: 3, y: 23, w: 3, h: 2 },
];
...
const professionalLayoutLg: Layout[] = [
  ...
  { i: "calendar", x: 0, y: 1, w: 6, h: 5, minW: 3, minH: 5 },
  { i: "day-timetable", x: 6, y: 1, w: 6, h: 6, minW: 3, minH: 3 },
  { i: "timeline", x: 6, y: 7, w: 6, h: 4, minW: 3, minH: 4 },
  { i: "emails", x: 0, y: 6, w: 6, h: 5, minW: 3, minH: 4 },
  { i: "next-month", x: 0, y: 11, w: 6, h: 4, minW: 3, minH: 3 },
...
const professionalLayoutMd: Layout[] = [
  ...
  { i: "calendar", x: 0, y: 1, w: 5, h: 4, minW: 3, minH: 4 },
  { i: "day-timetable", x: 5, y: 1, w: 5, h: 4, minW: 3, minH: 3 },
  { i: "timeline", x: 0, y: 5, w: 4, h: 3, minW: 2, minH: 2 },
  { i: "emails", x: 4, y: 5, w: 6, h: 5, minW: 2, minH: 2 },
  { i: "next-month", x: 0, y: 8, w: 4, h: 2, minW: 2, minH: 2 },
  { i: "sync", x: 0, y: 10, w: 5, h: 2 },
  { i: "data", x: 5, y: 10, w: 5, h: 2 },
];
...
const professionalLayoutSm: Layout[] = [
  ...
  { i: "sync", x: 0, y: 17, w: 3, h: 2 },
  { i: "data", x: 3, y: 17, w: 3, h: 2 },
];
